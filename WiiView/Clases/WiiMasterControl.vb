Public Class WiiMasterControl
    ...
    Protected Sub CheckLeftClicked(currentState As Boolean)
    ...
    Protected Sub CheckRightClicked(currentState As Boolean)
    ...
    Protected Sub CheckUpClicked(currentState As Boolean)
    ...
    Protected Sub CheckDownClicked(currentState As Boolean)
    ...
    Protected Sub CheckPlusClicked(currentState As Boolean)
    ...
    Protected Sub CheckDashClicked(currentState As Boolean)
        If Perfil.Equals("P1") Then
    ...
    Protected Sub CheckHomeClicked(currentState As Boolean)
        If Perfil.Equals("P1") Then
    ...
    Protected Sub CheckOneClicked(currentState As Boolean)
        If currentState Then
            Perfil = "P1"
        End If
    End Sub

    Protected Sub CheckTwoClicked(currentState As Boolean)
        If currentState Then
            Perfil = "P2"
        End If
    End Sub
